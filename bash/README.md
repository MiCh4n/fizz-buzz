...
- ### [Log checker](https://github.com/MiCh4n/fizz-buzz/blob/main/bash/log-checker/log_checker.sh)
    - #### Simple select script, counts 404 or ip/user occurs - provided with sample logs made with flog
- ### My-site-sh
    - ### [sync files](https://github.com/MiCh4n/fizz-buzz/blob/main/bash/my-site-sh/sync-files.sh)
